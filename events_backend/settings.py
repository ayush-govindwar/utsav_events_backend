...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-ac14%bszt^)f8qa9=bm^*ebh1_bi-oh%e8=v$wmgbh))ktea$q')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

# Add your Render domain here
ALLOWED_HOSTS = ['*']  # For now, restrict this later
...
LOGGING = {
    ...
    'loggers': {
        'your_app_name.email_service': {  # Replace 'your_app_name' with your actual app name
