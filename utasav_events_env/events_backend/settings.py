...
SECRET_KEY = 'django-insecure-ac14%bszt^)f8qa9=bm^*ebh1_bi-oh%e8=v$wmgbh))ktea$q'
...
BUSINESS_PHONE_NUMBER = os.getenv('BUSINESS_PHONE_NUMBER')  # Your business number

# Email Settings (SendGrid)
SENDGRID_API_KEY = os.getenv('SENDGRID_API_KEY')
BUSINESS_EMAIL = os.getenv('BUSINESS_EMAIL')  # Your business email
